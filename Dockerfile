...
ARG LIBPQ_DEV_VERSION=17.9-0+deb13u1
# renovate: datasource=deb depName=libcurl4-openssl-dev
ARG LIBCURL4_OPENSSL_DEV_VERSION=8.14.1-2+deb13u3
...
ARG NGINX_VERSION=1.26.3-3+deb13u4
...
ARG LIBPQ5_VERSION=17.9-0+deb13u1
# renovate: datasource=deb depName=libssl3t64
ARG LIBSSL3T64_VERSION=3.5.6-1~deb13u1
